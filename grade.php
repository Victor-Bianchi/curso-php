<div class="conteudo">
    ...
    <div class="modulo azul">
        ...
        <div class="modulo roxo-escuro">
            ...
            <ul>
                <li>
                    <a href="exercicio.php?dir=includes&file=return_require">
                        Return & Require
                    </a>
                </li>
                <li>
        ...
        <div class="modulo vermelho-escuro">
            ...
            <ul>
                ...
                <li>
                    <a href="exercicio.php?dir=funcoes&file=des_palindromo">
                        Desafio (Palíndromo)
                    </a>
                </li>
                <li>
                    <a href="exercicio.php?dir=funcoes&file=args">
                        Argumentos
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="exercicio.php?dir=funcoes&file=des_busca_recursiva">
